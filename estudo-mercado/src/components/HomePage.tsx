...
const OPORTUNIDADES: Oportunidade[] = [
  ...
  },
  {
    ...
    prazo: "02/10/2026",
    status: "aberto",
    descricao: "Diagnóstico de nível linguístico e capacitação continuada da equipe técnica e administrativa do NGUTAPA em Espanhol, Inglês e Francês, com elaboração de material didático, avaliações periódicas de aprendizagem e plano de continuidade da formação linguística institucional. Perfil mínimo: diploma em Letras, Linguística, Educação, Tradução ou áreas afins, 6 meses de experiência profissional e 6 meses em ensino de língua estrangeira. Serão especialmente valorizadas candidaturas de falantes nativos da língua Tikuna ou pertencentes a povos indígenas. Orçamento estimado: R$ 7.032,08.",
    temFormulario: false,
