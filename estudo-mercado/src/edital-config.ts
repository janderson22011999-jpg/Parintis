...
export const EDITAIS_CONFIG: Record<string, EditalConfig> = {
  ...
  "biologo-2026": {
    ...
    declaracaoEditalDesc: "Declaro que li e aceito as condições do TdR Biólogo(a) — Processo 003/2026 — Instituto NGUTAPA, incluindo escopo, cronograma, forma de pagamento e critérios de seleção.",
